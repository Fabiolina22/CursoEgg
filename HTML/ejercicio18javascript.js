...
let array1 = [true, 5, false, "adios", "hola" , 2];
let palabra = "";
...
for (let i = 0; i < array1.length; i++) {
    ...
    if (typeof array1[i] == "string") {
        (array1[i].length > palabra.length)?palabra=array1[i]:palabra;
...
(contB <= 2 )?msj = "Hay dos booleanos en el Array " : msj += "No hay dos booleanos en el array";
(contB > 2 )? msj += "por ende hay mas de dos booleanos":msj+= "por ende no hay mas de dos booleanos en el array"; 
